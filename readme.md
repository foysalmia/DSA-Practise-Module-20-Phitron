...
## Task 2
Given an integer N. Write a program to print all prime numbers between 1 and N.<br>
...
## Task 6
Given a sorted integer array A with size N integers and an integer k. Write a program to find out the position of k from array A using binary search. <br>
Sample input:<br>
7 9<br>
1 2 3 4 9 7 8<br>
Sample output:<br>
...
## Task 7
Given an integer array A with size N. Write a program to print the number of distinct integers in A.<br>
Sample input:<br>
7<br>
2 3 3 4 5 5 5 <br>
<br>
...
## Task 8
Given a matrix A with dimension n*m. Write a program to print the sum of the elements where the rows are even and the columns are odd .<br>
          Sample input:<br>
          3 3<br>
          1 2 3<br>
          4 5 6<br>
...
## Task 15
Write a function named move_tail() which will move the tail to the first position of the list.<br>
...
## Task 19
Write a function named move_head() which will move the head to the last position of the list.<br>
For example: If the list looks like this,<br>
List: 2 <-> 4 <-> 1 <-> 10 <-> 5<br>
After the operation the list will look like this,<br>
List: 4 <-> 1 <-> 10 <-> 5 <-> 2<br>
